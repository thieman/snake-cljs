...
{{
var G__4388 = cljs.core.pop.call(null,v__$1);
v__$1 = G__4388;
continue;
}
} else
...
{var pred__4392 = cljs.core._EQ_;var expr__4393 = limit;if(pred__4392.call(null,1,expr__4393))
{return cljs.core.vector.call(null,s);
} else
{if(pred__4392.call(null,2,expr__4393))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__4395 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__4396 = (limit__$1 - 1);
var G__4397 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__4395;
limit__$1 = G__4396;
parts = G__4397;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___4399 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___4399))
{var replacement_4400 = temp__4090__auto___4399;buffer.append([cljs.core.str(replacement_4400)].join(''));
} else
{buffer.append(ch);
}
{
