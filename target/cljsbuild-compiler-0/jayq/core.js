...
var G__4297 = null;
var G__4297__2 = (function (self__,k){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k);
});
var G__4297__3 = (function (self__,k,not_found){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k,not_found);
});
...
;
jQuery.prototype.apply = (function (self__,args4296){return self__.call.apply(self__,[self__].concat(args4296.slice()));
});
...
var hide__delegate = function ($elem,p__4298){var vec__4300 = p__4298;var speed = cljs.core.nth.call(null,vec__4300,0,null);var on_finish = cljs.core.nth.call(null,vec__4300,1,null);return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__4298 = null;if (arguments.length > 1) {
  p__4298 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return hide__delegate.call(this,$elem,p__4298);};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__4301){
var $elem = cljs.core.first(arglist__4301);
var p__4298 = cljs.core.rest(arglist__4301);
return hide__delegate($elem,p__4298);
});
...
var show__delegate = function ($elem,p__4302){var vec__4304 = p__4302;var speed = cljs.core.nth.call(null,vec__4304,0,null);var on_finish = cljs.core.nth.call(null,vec__4304,1,null);return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__4302 = null;if (arguments.length > 1) {
  p__4302 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return show__delegate.call(this,$elem,p__4302);};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__4305){
var $elem = cljs.core.first(arglist__4305);
var p__4302 = cljs.core.rest(arglist__4305);
return show__delegate($elem,p__4302);
});
...
var toggle__delegate = function ($elem,p__4306){var vec__4308 = p__4306;var speed = cljs.core.nth.call(null,vec__4308,0,null);var on_finish = cljs.core.nth.call(null,vec__4308,1,null);return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__4306 = null;if (arguments.length > 1) {
  p__4306 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return toggle__delegate.call(this,$elem,p__4306);};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__4309){
var $elem = cljs.core.first(arglist__4309);
var p__4306 = cljs.core.rest(arglist__4309);
return toggle__delegate($elem,p__4306);
});
...
var fade_out__delegate = function ($elem,p__4310){var vec__4312 = p__4310;var speed = cljs.core.nth.call(null,vec__4312,0,null);var on_finish = cljs.core.nth.call(null,vec__4312,1,null);return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__4310 = null;if (arguments.length > 1) {
  p__4310 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_out__delegate.call(this,$elem,p__4310);};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__4313){
var $elem = cljs.core.first(arglist__4313);
var p__4310 = cljs.core.rest(arglist__4313);
return fade_out__delegate($elem,p__4310);
});
...
var fade_in__delegate = function ($elem,p__4314){var vec__4316 = p__4314;var speed = cljs.core.nth.call(null,vec__4316,0,null);var on_finish = cljs.core.nth.call(null,vec__4316,1,null);return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__4314 = null;if (arguments.length > 1) {
  p__4314 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_in__delegate.call(this,$elem,p__4314);};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__4317){
var $elem = cljs.core.first(arglist__4317);
var p__4314 = cljs.core.rest(arglist__4317);
return fade_in__delegate($elem,p__4314);
});
...
var slide_up__delegate = function ($elem,p__4318){var vec__4320 = p__4318;var speed = cljs.core.nth.call(null,vec__4320,0,null);var on_finish = cljs.core.nth.call(null,vec__4320,1,null);return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__4318 = null;if (arguments.length > 1) {
  p__4318 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_up__delegate.call(this,$elem,p__4318);};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__4321){
var $elem = cljs.core.first(arglist__4321);
var p__4318 = cljs.core.rest(arglist__4321);
return slide_up__delegate($elem,p__4318);
});
...
var slide_down__delegate = function ($elem,p__4322){var vec__4324 = p__4322;var speed = cljs.core.nth.call(null,vec__4324,0,null);var on_finish = cljs.core.nth.call(null,vec__4324,1,null);return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__4322 = null;if (arguments.length > 1) {
  p__4322 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_down__delegate.call(this,$elem,p__4322);};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__4325){
var $elem = cljs.core.first(arglist__4325);
var p__4322 = cljs.core.rest(arglist__4325);
return slide_down__delegate($elem,p__4322);
});
...
var closest__delegate = function ($elem,selector,p__4326){var vec__4328 = p__4326;var context = cljs.core.nth.call(null,vec__4328,0,null);return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__4326 = null;if (arguments.length > 2) {
  p__4326 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return closest__delegate.call(this,$elem,selector,p__4326);};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__4329){
var $elem = cljs.core.first(arglist__4329);
arglist__4329 = cljs.core.next(arglist__4329);
var selector = cljs.core.first(arglist__4329);
var p__4326 = cljs.core.rest(arglist__4329);
return closest__delegate($elem,selector,p__4326);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__4332){var map__4334 = p__4332;var map__4334__$1 = ((cljs.core.seq_QMARK_.call(null,map__4334))?cljs.core.apply.call(null,cljs.core.hash_map,map__4334):map__4334);var request = map__4334__$1;var contentType = cljs.core.get.call(null,map__4334__$1,new cljs.core.Keyword(null,"contentType","contentType",624772805));var data = cljs.core.get.call(null,map__4334__$1,new cljs.core.Keyword(null,"data","data",1016980252));var ct = jayq.core.__GT_content_type.call(null,contentType);return (function (p1__4331_SHARP_){if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null,ct)))
{return cljs.core.assoc.call(null,p1__4331_SHARP_,new cljs.core.Keyword(null,"data","data",1016980252),cljs.core.pr_str.call(null,data));
} else
{return p1__4331_SHARP_;
}
}).call(null,(function (p1__4330_SHARP_){if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__4330_SHARP_,new cljs.core.Keyword(null,"contentType","contentType",624772805),ct);
} else
...
;
jayq.core.xhr = (function xhr(p__4335,content,callback){var vec__4337 = p__4335;var method = cljs.core.nth.call(null,vec__4337,0,null);var uri = cljs.core.nth.call(null,vec__4337,1,null);var params = cljs.core.clj__GT_js.call(null,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"type","type",1017479852),clojure.string.upper_case.call(null,cljs.core.name.call(null,method)),new cljs.core.Keyword(null,"data","data",1016980252),cljs.core.clj__GT_js.call(null,content),new cljs.core.Keyword(null,"success","success",3441701749),callback], true));return jQuery.ajax(uri,params);
});
/**
...
var unbind__delegate = function ($elem,ev,p__4338){var vec__4340 = p__4338;var func = cljs.core.nth.call(null,vec__4340,0,null);return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__4338 = null;if (arguments.length > 2) {
  p__4338 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unbind__delegate.call(this,$elem,ev,p__4338);};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__4341){
var $elem = cljs.core.first(arglist__4341);
arglist__4341 = cljs.core.next(arglist__4341);
var ev = cljs.core.first(arglist__4341);
var p__4338 = cljs.core.rest(arglist__4341);
return unbind__delegate($elem,ev,p__4338);
});
...
var on__delegate = function ($elem,events,p__4342){var vec__4344 = p__4342;var sel = cljs.core.nth.call(null,vec__4344,0,null);var data = cljs.core.nth.call(null,vec__4344,1,null);var handler = cljs.core.nth.call(null,vec__4344,2,null);return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__4342 = null;if (arguments.length > 2) {
  p__4342 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return on__delegate.call(this,$elem,events,p__4342);};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__4345){
var $elem = cljs.core.first(arglist__4345);
arglist__4345 = cljs.core.next(arglist__4345);
var events = cljs.core.first(arglist__4345);
var p__4342 = cljs.core.rest(arglist__4345);
return on__delegate($elem,events,p__4342);
});
...
var one__delegate = function ($elem,events,p__4346){var vec__4348 = p__4346;var sel = cljs.core.nth.call(null,vec__4348,0,null);var data = cljs.core.nth.call(null,vec__4348,1,null);var handler = cljs.core.nth.call(null,vec__4348,2,null);return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__4346 = null;if (arguments.length > 2) {
  p__4346 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return one__delegate.call(this,$elem,events,p__4346);};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__4349){
var $elem = cljs.core.first(arglist__4349);
arglist__4349 = cljs.core.next(arglist__4349);
var events = cljs.core.first(arglist__4349);
var p__4346 = cljs.core.rest(arglist__4349);
return one__delegate($elem,events,p__4346);
});
...
var off__delegate = function ($elem,events,p__4350){var vec__4352 = p__4350;var sel = cljs.core.nth.call(null,vec__4352,0,null);var handler = cljs.core.nth.call(null,vec__4352,1,null);return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__4350 = null;if (arguments.length > 2) {
  p__4350 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return off__delegate.call(this,$elem,events,p__4350);};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__4353){
var $elem = cljs.core.first(arglist__4353);
arglist__4353 = cljs.core.next(arglist__4353);
var events = cljs.core.first(arglist__4353);
var p__4350 = cljs.core.rest(arglist__4353);
return off__delegate($elem,events,p__4350);
});
...
done.cljs$lang$applyTo = (function (arglist__4354){
var deferred = cljs.core.first(arglist__4354);
var fns_args = cljs.core.rest(arglist__4354);
...
fail.cljs$lang$applyTo = (function (arglist__4355){
var deferred = cljs.core.first(arglist__4355);
var fns_args = cljs.core.rest(arglist__4355);
...
always.cljs$lang$applyTo = (function (arglist__4356){
var deferred = cljs.core.first(arglist__4356);
var fns_args = cljs.core.rest(arglist__4356);
